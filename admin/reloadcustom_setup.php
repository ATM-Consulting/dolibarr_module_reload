...
require_once '../lib/reloadcustom.lib.php';
...
$head = reloadcustomAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104863Name"),
    0,
