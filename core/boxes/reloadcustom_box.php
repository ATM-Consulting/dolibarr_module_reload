 ...
 */
class reloadcustombox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "reloadcustom@reloadcustom";
    public $boxlabel;
    public $depends = array("reloadcustom");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/reloadcustom/class/reloadcustom.class.php";
