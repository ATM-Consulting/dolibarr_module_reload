...
/**
 * 	\file		core/triggers/interface_99_modMyodule_ReloadCustomtrigger.class.php
 * 	\ingroup	reloadcustom
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modReloadcustom_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceReloadCustomtrigger
{
